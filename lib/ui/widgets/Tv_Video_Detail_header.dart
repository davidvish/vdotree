...
class Tvvideo extends StatefulWidget {
  Tvvideo(this.videoDetail);

  final Datum videoDetail;

  @override
  _TvvideoState createState() => _TvvideoState();
}

class _TvvideoState extends State<Tvvideo> with WidgetsBindingObserver {
  var dMsg = '';
  var hdUrl;
  var sdUrl;
  var mReadyUrl,
  ...
  void _onTapTrailer() {
    ...
    var trailerUrl =  APIData.trailerPlayer +
                '${userDetails.user.id}/${userDetails.code}/${widget.videoDetail.id}';
    if (trailerUrl == null) {
