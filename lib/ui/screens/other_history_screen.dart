...
//farman
  Widget subscriptionFromEnd(planDetails) {
    print("testtt");
    print(planDetails);
...
//farman i create new widget to solve to type of display paln details(free and paid)
  Widget freeTrailPaymentDetail(planDetails) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Padding(
                  ...
                  // planDetails.price !=0?
                  //
                  subscriptionFromEnd(planDetails),
                ),
              ),
  ...
  Widget paymentDetails(planDetails) {
    print("hhfffffffffffffffffffffff");
    print(planDetails.plan);
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
          ...
          child: Wrap(
            ...
            children: <Widget>[
             ...
             Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(left: 20),
                  child: subscriptionFromEnd(planDetails)
...
//   Cards that display history
  Widget historyCard(planDetails) {
    ...
    // print(planDetails.data.map((message) => message.body));
    return Card(
          ...
          Column(
            children: <Widget>[
              ...
              planDetails.plan == null
                  ? freeTrailPaymentDetail(planDetails)
...
//  Build method
  ...
  Widget build(BuildContext context) {
    ...
    var paypalHistory = Provider.of<UserProfileProvider>(context, listen: false)
        .userProfileModel
        .paypal;
    var myData = Provider.of<UserProfileProvider>(context, listen: false).myResponse();
    print('myResponseData ${myData}');
    print("*******************");
...
//  Cards that shows history
  List<Card> _buildCards(int count) {
    var paypalHistory = Provider.of<UserProfileProvider>(context, listen: false)
        .userProfileModel
        .paypal;
    print('paypalHist ${paypalHistory[0].subscriptionTo}');
