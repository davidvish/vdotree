...
import 'package:IQRA/ui/widgets/credit_card_form.dart';
import 'package:IQRA/ui/widgets/credit_card_model.dart';
import 'package:IQRA/ui/widgets/credit_card_widget.dart';
import 'package:IQRA/ui/widgets/profile_tile.dart';
  ...
  Future<String> _createSubscription(customerStripeId, cardid, cardtype,
    ...
    if (widget.couponCode != '') {
      var stripeUri = "https://api.stripe.com/v1/customers/" +
          ...
          "&coupon=" +
          "${widget.couponCode}";
      subscriptionResponse = await http.post(Uri.encodeFull("$stripeUri"),
          headers: {HttpHeaders.authorizationHeader: "Bearer $stripePass"});
    } else {
