...
const primaryBlue = Color.fromRGBO(253, 243, 8, 3);
...
TextTheme _buildTextTheme(TextTheme base) {
  return base
      .copyWith(
        ...
        headline2: base.headline2.copyWith(fontSize: 18.0),
      ...
      .copyWith(headline1: base.headline1.copyWith(fontFamily: 'Roboto'));
}
